...
rules that came from a real bug, and [docs/intent.md](docs/intent.md) for what this project
is for, what a fork must keep, and which of its own success criteria are currently red. Issues labeled
